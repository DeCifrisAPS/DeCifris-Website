...
import { Modcrypto26Component } from './attivita/corsi/modcrypto26/modcrypto26.component';
...
const routes: Routes = [
	// home e miscellanea
	{
		path: "", component: RootElementsComponent, children: [
			...
			{
				path: "pqcifris25", component: pqcifris25Component, data: {
					title: 'PQCifris25: migration to PQ cryptography',
					meta: [
						{ name: 'description', content: 'PQCifris25: migration to PQ cryptography' },
						{ property: 'og:title', content: 'PQCifris25: migration to PQ cryptography' }
					]
				}
			},
			{
	...
	// path ./attivita
	{
		path: "attivita", component: AttivitaComponent, children: [
			...
			{ path: 'modcrypto26', component: Modcrypto26Component, data: { title: 'ModCrypto26: Crittografia Moderna 2026'}},
	...
	{ path: 'modcrypto26', redirectTo: '/attivita/modcrypto26', pathMatch: 'full' },
