...
@Component({
	selector: 'app-combinatorics24',
	templateUrl: './combinatorics24.component.html',
	styleUrls: ['./combinatorics24.component.css']
})
export class Combinatorics24Component implements OnInit {
